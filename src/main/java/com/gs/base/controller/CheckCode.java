...
public class CheckCode extends HttpServlet {
    ...
    /**
     * /checkCodeAction/getCheckCode.do
     *  获取图形验证码
     * @param request
     * @param response
    ...
    @ResponseBody
    public HashMap<String, Object> checkCode(HttpServletRequest request, HttpServletResponse response) {
        HashMap<String, Object> map = new HashMap<>();
        String checkCode = request.getParameter("checkCode");
        HttpSession session = request.getSession(true);
        String randCheckCode = (String) session.getAttribute("randCheckCode");

        if (MyStringUtil.isNotEmpty(checkCode)) {
